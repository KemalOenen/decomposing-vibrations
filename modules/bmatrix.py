...
def b_matrix2(atoms, bonds, angles, linear_angles, out_of_plane, dihedrals, idof):
    ...
    for bond in bonds:
        ...
        if i_internal == 0:
            ...
            matrix[i_internal, index[1]:index[1]+3] = B_Matrix_Entry_BondLength(coord[0], coord[1])
        if i_internal == 1:
            matrix[i_internal, index[0]:index[0]+3] = B_Matrix_Entry_BondLength(coord[1], coord[0]) + B_Matrix_Entry_BondLength(coord[1], coord[0])
            matrix[i_internal, index[1]:index[1]+3] = B_Matrix_Entry_BondLength(coord[0], coord[1]) + B_Matrix_Entry_BondLength(coord[1], coord[0])
        if i_internal == 2:
            matrix[i_internal, index[0]:index[0]+3] = B_Matrix_Entry_BondLength(coord[1], coord[0]) - B_Matrix_Entry_BondLength(coord[1], coord[0])
            matrix[i_internal, index[1]:index[1]+3] = B_Matrix_Entry_BondLength(coord[0], coord[1]) - B_Matrix_Entry_BondLength(coord[1], coord[0])
        i_internal += 1
    for angle in angles:
        ...
        coord = [coordinates[atom_index[a]] for a in angle]
        if i_internal == 3:
            matrix[i_internal, index[0]:index[0]+3] = B_Matrix_Entry_Angle_AtomB(coord[1], coord[0], coord[2]) + B_Matrix_Entry_Angle_AtomB(coord[1], coord[0], coord[2])
            matrix[i_internal, index[1]:index[1]+3] = B_Matrix_Entry_Angle_AtomA(coord[1], coord[0], coord[2]) + B_Matrix_Entry_Angle_AtomA(coord[1], coord[0], coord[2])
            matrix[i_internal, index[2]:index[2]+3] = B_Matrix_Entry_Angle_AtomC(coord[1], coord[0], coord[2]) + B_Matrix_Entry_Angle_AtomC(coord[1], coord[0], coord[2])
        if i_internal == 4:
            matrix[i_internal, index[0]:index[0]+3] = B_Matrix_Entry_Angle_AtomB(coord[1], coord[0], coord[2]) - B_Matrix_Entry_Angle_AtomB(coord[1], coord[0], coord[2])
            matrix[i_internal, index[1]:index[1]+3] = B_Matrix_Entry_Angle_AtomA(coord[1], coord[0], coord[2]) - B_Matrix_Entry_Angle_AtomA(coord[1], coord[0], coord[2])
            matrix[i_internal, index[2]:index[2]+3] = B_Matrix_Entry_Angle_AtomC(coord[1], coord[0], coord[2]) - B_Matrix_Entry_Angle_AtomC(coord[1], coord[0], coord[2])
